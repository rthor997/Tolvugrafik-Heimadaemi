...
//     Búum til bókstafinn H úr þremur teningum uppfært til að sýna kallax hillueiningu
//
...
function render()
{
    ...
    // Build the letter H...
    // First the right leg
    mv1 = mult( mv, translate( -0.75, 0.0, 0.0 ) );
    ...
    mv1 = mult( mv, scalem( 1.5, 0.1, 0.5 ) );
    gl.uniformMatrix4fv(matrixLoc, false, flatten(mv1));
    gl.drawArrays( gl.TRIANGLES, 0, numVertices );

    // bar fyrir botn 
    mv1 = mult( mv, translate( 0.0, -0.77, 0.0 ) );
