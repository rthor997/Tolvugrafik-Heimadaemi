...
//    gl.cullFace(gl.BACK);
    ...
    var shadingLoc = gl.getUniformLocation(program, "useBlinnPhong");
    gl.uniform1i(shadingLoc, useBlinnPhong);

    document.getElementById("Breyta-Shading").onclick = function () {
        useBlinnPhong = !useBlinnPhong;
        gl.uniform1i(shadingLoc, useBlinnPhong);

        console.log(useBlinnPhong ? "Blinn-Phong" : "Phong");
    };
